      ...
      <div className="w-full md:w-xl mx-auto">
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className="h-12 bg-white text-black text-lg"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Link
                    ...
                    className="text-[#ff7e5f] hover:underline cursor-pointer flex items-center justify-end w-full mt-1"
                  >
                    Forgot Password?
                  </Link>
                </FormItem>
            ...
            <h1>
              By continuing, you confirm that you are 6 years or older and agree
              to our{" "}
              <Link href="#" className="text-[#ff7e5f] hover:underline">
                Terms & Conditions
              </Link>{" "}
              and{" "}
              <Link href="#" className="text-[#ff7e5f] hover:underline">
            ...
            <h1 className="text-center text-lg font-medium mt-1">
              ...
              <Link href="/register" className="text-[#ff7e5f] hover:underline">
                Register
              </Link>
            </h1>
          </form>
