...
} from "@/redux/features/other/other.api";
...
function Question() {
  ...
  const { data, isFetching } = useRandomQuestionQuery([
  ...
  if (questions?.length < 1) {
    return (
      <p className="text-white text-2xl font-bold text-center my-12">
        No Data Found
      </p>
    );
  }
      ...
      <div className="p-6 bg-white rounded-lg shadow-md w-full">
        ...
        >
          <div className="flex items-center justify-center gap-10 h-36">
            ...
            <Image
              src={
                currentQuestion?.topic?.title === "Addition"
                  ? addition_1
                  : currentQuestion?.topic?.title === "Subtraction"
                  ? subtraction_1
                  : currentQuestion?.topic?.title === "Multiplication"
                  ? multiplication_1
                  : division_1
              }
              alt="icon"
